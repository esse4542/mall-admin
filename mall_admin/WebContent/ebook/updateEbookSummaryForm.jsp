...
<%
   ...
   System.out.println(ebookISBN + "<--updateEbookSummaryForm.jsp 에서 ebookISBN");
%>
<!DOCTYPE html>
<html>
<head>
 ...
 <!-- ======= Hero Section ======= -->
  ...
  >
	<%--  <%
		...
		System.out.println("ebookISBN : " + ebookISBN); // ebookISBN 확인
		System.out.println("rowPerPage : " + rowPerPage);
	%> --%>
	
	<!-- summaryForm에서 홈으로 갈 수 있는 사이트 만들기 -->
	...
	<form action="<%=request.getContextPath()%>/ebook/updateEbookSummaryAction.jsp" method="post">
		...
		<!-- rowperPage는 선언하지 않아서 부르지 않음 -->
		
		<table class="table table-bordered table-sm">
			<tr>
				<td>ebookSummary</td>
				<td><textarea rows="5" cols="80" name="ebookSummary" class="form-control"></textarea></td>
			</tr>
		</table>
		<br>
