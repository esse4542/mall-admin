...
<!-- ======= 모바일 탐색 토글 버튼 ======= -->
    ...
    <div class="d-flex flex-column">
      ...
      <nav class="nav-menu">
        <ul>
          ...
          <li class="active"><a href="<%=request.getContextPath()%>/category/categoryList.jsp"><i class="bx bx-server"></i> 상품카테고리 관리</a></li>
 ...
 <!-- ======= Hero Section ======= -->
  ...
  <main id="main">
	...
	<a href="<%=request.getContextPath()%>/category/insertCategoryForm.jsp"><button type="button" class="btn btn-outline-dark btn-sm">카테고리 추가</button></a>
	<br>
	<table class="table table-bordered table-sm">
	<br>
		<thead>
			<tr>
				<th class="table-primary">categoryName</th>
				<th class="table-primary">categoryWeight [수정]</th> <!-- 수정 가능하게 만들기 -->
                ...
                <input type="hidden" name="categoryName" value="<%=c.getCategoryName() %>">
                  <select name="categoryWeight">
                    ...
                    <button type="submit" class="btn btn-light btn-sm">수정</button>
                     ...
                     <td><a href="<%=request.getContextPath()%>/category/deleteCategoryAction.jsp?categoryName=<%=c.getCategoryName()%>" class="btn btn-light btn-sm">삭제</a></td>
        </tr>
         <%
            }
         %>      
