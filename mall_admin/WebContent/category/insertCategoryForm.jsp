  ...
  <main id="main">
   ...
   <!-- ======= About Section ======= -->
	...
	<form action="<%=request.getContextPath()%>/category/insertCategoryAction.jsp" method="post">
		...
		<br>
		<button type="submit" type="submit" class="btn btn-outline-dark btn-sm">등록</button>
	</form>
