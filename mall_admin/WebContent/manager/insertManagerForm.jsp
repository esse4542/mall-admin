...
<!-- ======= 모바일 탐색 토글 버튼 ======= -->
 ...
 <!-- ======= Hero Section ======= -->
  ...
  <main id="main">
   ...
   <!-- ======= About Section ======= -->
  <section id="insertManagerForm" class="insertManagerForm">
      <div class="container">

        <div class="section-title">
          <h2>매니저 등록</h2>
          <p>매니저를 등록하실 수 있습니다.</p>
        </div>
	...
	<form action="<%=request.getContextPath()%>/manager/insertManagerAction.jsp" method="post">
		<table class="table-bordered table-sm">
			<tr>
				<td class="table-dark">manager_id</td>
				<td><input type="text" name="managerId" class="form-control"></td>
			</tr>
			
			<tr>
				<td class="table-dark">manager_pw</td>
				<td><input type="password" name="managerPw" class="form-control"></td>
			</tr>
			
			<tr>
				<td class="table-dark">manager_name</td>
				<td><input type="text" name="managerName" class="form-control"></td>
			</tr>
			
		</table>
		<br>
		<button type="submit" class="btn btn-outline-dark btn-sm">매니저 등록</button>
	</form>
