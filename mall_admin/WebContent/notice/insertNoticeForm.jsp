	...
	<input type="hidden" name="managerId" value="<%=manager.getManagerId()%>">	
		<table class="table table-bordered table-sm">
			<tr>
				...
				<td>
					<input type="text" name="noticeTitle" required="required" class="form-control">
				</td>
			</tr>
			<tr>
				<th class="table-dark">noticeContent</th>
				<td>
					<textarea rows="10" cols="80" name="noticeContent" required="required" class="form-control"></textarea>
				</td>
			</tr>
		</table>
